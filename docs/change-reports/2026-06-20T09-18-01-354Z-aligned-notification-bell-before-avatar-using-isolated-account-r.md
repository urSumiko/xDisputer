...
- Created: 2026-06-20T09:18:01.403Z
...
```text
M	components/ClientOutputLimitBoundary.tsx
...
```text
components/ClientOutputLimitBoundary.tsx         |  29 ++++--
 ...
 10 files changed, 241 insertions(+), 59 deletions(-)
```
...
### app/notification-account-rail.css
...
```text
/* Notification Account Rail FBIS
   Owns only the notification/avatar row inside AccountMenu.
   ConsoleShell remains layout-only.
*/

.manager-header-account-dock[data-console-account-menu="true"] {
...
/* Supports current direct-child AccountMenu structure. */
.manager-header-account-dock[data-console-account-menu="true"] > .notification-dock[data-notification-dock="true"] {
  position: relative !important;
...
.manager-header-account-dock[data-console-account-menu="true"] > .manager-header-account-avatar {
  order: 2 !important;
  flex: 0 0 auto !important;
}

/* Supports newer wrapped row structure. */
.manager-account-rail-actions[data-notification-avatar-row="true"] {
  width: 100% !important;
...
.manager-account-rail-actions[data-notification-avatar-row="true"] > .notification-dock[data-notification-dock="true"] {
  position: relative !important;
  inset: auto !important;
  top: auto !important;
  right: auto !important;
...
.manager-account-rail-actions[data-notification-avatar-row="true"] > .manager-header-account-avatar {
  order: 2 !important;
  flex: 0 0 auto !important;
}

.manager-header-account-dock[data-console-account-menu="true"] .notification-dock-button {
  width: clamp(38px, 3.2vw, 44px) !important;
  height: clamp(38px, 3.2vw, 44px) !important;
  border-radius: 14px !important;
}

.manager-header-account-dock[data-console-account-menu="true"] .notification-dock-popover {
  right: 0 !important;
  left: auto !important;
