...
must(contract, 'readEndpoint:', 'notification ownership contract must declare read endpoint');
must(contract, '/read', 'notification ownership contract must end read endpoint at read route');
