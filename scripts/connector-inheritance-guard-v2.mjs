...
const requiredScripts = {
  ...
  'connection-inheritance:guard': ['connector-inheritance-guard-v2.mjs'],
...
const requiredFiles = [
  {
    ...
    contains: ['Arisu-art/xDisputer', 'User prompt alias observed', 'access_workspace_attention_queue_v1']
  },
  {
    path: 'docs/active-connector-inheritance.md',
    contains: ['GitHub', 'Supabase', 'Figma', 'Context7', 'Arisu-art/xDisputer']
  },
  {
...
console.log('\n=== xDisputer connector inheritance guard v2 ===');
