...
function hasAny(source, terms, label) { checks.push({ ok: terms.some((term) => source.includes(term)), label }); }
...
hasAny(configurator, ['Supabase is authoritative', 'Verified as active Supabase manager default'], 'local preview cannot block active database mutation state');
