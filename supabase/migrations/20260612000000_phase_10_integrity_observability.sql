...
create index if not exists generation_integrity_created_idx
on public.generation_integrity_events(created_at desc);
...
analyze public.generation_integrity_events;
